...
int main() {
    ...
    structParam.computeParameters<double, double, double, double>(gen, std::function<double(double const &)>(call), eulerScheme, N);
    ...
    Estimator<double, double, double, double> estimatorMC(gen, std::function<double(double const &)>(call), eulerScheme, multilevelParamMC);
    Estimator<double, double, double, double> estimatorRR(gen, std::function<double(double const &)>(call), eulerScheme, multilevelParamRR);
