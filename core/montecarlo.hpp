...
public:
    ...
    int getModelSize() const {return m_modelSize;}
    /** Total number of simulations getter. */
    int getTotalSize() const {return m_totalN;}
    /** @} */
...
public:
    ...
    DoubleMonteCarlo(mt19937_64& gen,
                     std::function<double(TransitionType)> f,
                     const schemePtr<StateType, VolType, RandomType, TransitionType> scheme,
                     const int modelDisc1,
                     const int modelDisc2);
    ...
    int getModelSize1() const {return m_modelSize1;}
    /** Second discretization size getter. */
    int getModelSize2() const {return m_modelSize2;}
    /** Total number of simulations getter. */
    int getTotalSize() const {return m_totalN;}
    /** @} */
 ...
 */
template<typename StateType, typename VolType, typename RandomType, typename TransitionType>
double MonteCarlo<StateType, VolType, RandomType, TransitionType>::operator()(const int N){
...
DoubleMonteCarlo<StateType, VolType, RandomType, TransitionType>::DoubleMonteCarlo(mt19937_64& gen,
                                                                   std::function<double(TransitionType)> f,
                                                                   const schemePtr<StateType, VolType, RandomType, TransitionType> scheme,
                                                                   const int modelSize1,
                                                                   const int modelSize2):
 ...
 */
template<typename StateType, typename VolType, typename RandomType, typename TransitionType>
double DoubleMonteCarlo<StateType, VolType, RandomType, TransitionType>::operator()(const int N){
